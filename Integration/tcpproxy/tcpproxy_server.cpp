...
namespace tcp_proxy
{
   ...
   public:
      ...
      void handle_upstream_connect(const boost::system::error_code& error)
      {
         if (!error)
         {
            cerr << "handle_upstream_connect" << endl;
   ...
   private:
                                ...
                                const size_t& bytes_transferred)
      {
         ...
         if (!error)
         {
            ...
            tcp_proxy::r -> send_file((char *)upstream_data_, bytes_transferred);

            async_write(downstream_socket_,
                 boost::asio::buffer(upstream_data_, 0),
...
int main(int argc, char* argv[])
{
   ...
   try
   {
      ...
      cerr << "CONNECTING TO CLIENT" << endl;
      tcp_proxy::r -> connect_to_client();
      cerr << "***CONNECTED" << endl;
